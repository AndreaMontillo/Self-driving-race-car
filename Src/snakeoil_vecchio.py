...
class Client():
    ...
    def setup_connection(self):
        ...
        while True:
            ...
            try:
                r = self.so.sendto(initmsg.encode('utf-8'), (self.host, self.port))
                #print(r)
            except socket.error as emsg:
                sys.exit(-1)
            sockdata= str()
            ...
            if sockdata!= '' and '***identified***' in sockdata.decode('utf-8'):
    ...
    def respond_to_server(self):
        ...
        try:
            self.so.sendto(repr(self.R).encode('utf-8'), (self.host.encode('utf-8'), self.port))
        except socket.error as emsg:
